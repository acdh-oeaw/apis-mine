...
ALLOWED_HOSTS = re.sub(
    r"https?://",
    "",
    os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,paas.acdh-dev.oeaw.ac.at,paas.acdh.oeaw.ac.at"),
).split(",")
...
INSTALLED_APPS += ["haystack", "paas_theme", "leaflet", "sass_processor", "django_extensions"]
...
CSP_DEFAULT_SRC = ("'self' data:","'self'", "'unsafe-inline'", 'cdnjs.cloudflare.com', 'cdn.jsdelivr.net', 'fonts.googleapis.com', 
                    ...
                    "openstreetmap.org", "*.openstreetmap.org", "oeaw.ac.at", "*.oeaw.ac.at")
